...
from ParticleInterpolation import *
from dolfin import *
from mshr import *
...
fluid_mesh = BoxMesh(Point(0, 0, 0), Point(1, 1, 1), n_mesh, n_mesh, n_mesh)
solid_mesh = generate_mesh(Sphere(Point(0.6, 0.5, 0.5), 0.2), 60)
